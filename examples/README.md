...
- `community_issue_candidates.json` is a generated public GitHub issue intake list from `scripts/benchmarks/community_issue_scout.py`; treat it as a triage artifact, not as a gate decision. Use `scripts/benchmarks/community_issue_solver.py` to create AANA-gated workpacks for individual candidates.
