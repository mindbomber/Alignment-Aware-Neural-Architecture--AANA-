...
- MCP-Bench next submission target: AANA should be evaluated as a paired control layer around the same base agent, not as a standalone model row. See [docs/aana-mcp-bench-submission-plan.md](docs/aana-mcp-bench-submission-plan.md).
