...
- Added MIT license, contributing guide, security policy, code of conduct, and citation metadata.
...
- Added the AANA framework manuscript under `papers/`.
- Added the invisible divergence and layered alignment dynamics companion paper under `papers/`.
