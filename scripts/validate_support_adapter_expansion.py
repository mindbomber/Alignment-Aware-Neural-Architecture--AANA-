...
def validate_expansion_plan(path=DEFAULT_PLAN):
    ...
    if release_gate.get("script") != "scripts/validate_support_adapter_expansion.py":
        errors.append("release_gate.script must point to scripts/validate_support_adapter_expansion.py.")
