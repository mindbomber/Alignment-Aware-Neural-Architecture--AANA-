...
def validate_first_deployable_baseline(path=DEFAULT_BASELINE, require_reached=False):
    ...
    if release_gate.get("script") != "scripts/validation/validate_first_deployable_baseline.py":
        errors.append("release_gate.script must point to scripts/validation/validate_first_deployable_baseline.py.")
