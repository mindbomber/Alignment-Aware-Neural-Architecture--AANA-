...
def validate_support_sla_failure_policy(path=DEFAULT_POLICY):
    ...
    if release_gate.get("script") != "scripts/validation/validate_support_sla_failure_policy.py":
        errors.append("release_gate.script must point to scripts/validation/validate_support_sla_failure_policy.py.")
