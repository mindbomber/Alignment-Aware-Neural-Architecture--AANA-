...
def validate_plan(path=DEFAULT_PLAN):
    ...
    if release_gate.get("script") != "scripts/validation/validate_incident_response_plan.py":
        _add(errors, "release_gate.script must point to scripts/validation/validate_incident_response_plan.py.")
