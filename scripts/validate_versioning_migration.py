...
def validate_versioning_migration(path=DEFAULT_POLICY, evidence_registry=DEFAULT_EVIDENCE_REGISTRY):
    ...
    if release_gate.get("script") != "scripts/validate_versioning_migration.py":
        errors.append("release_gate.script must point to scripts/validate_versioning_migration.py.")
