...
def validate_policy(policy_path=DEFAULT_POLICY, fixture_path=DEFAULT_SUPPORT_FIXTURES):
    ...
    if release_gate.get("script") != "scripts/validate_audit_retention_policy.py":
        _add(errors, "release_gate.script must point to scripts/validate_audit_retention_policy.py.")
