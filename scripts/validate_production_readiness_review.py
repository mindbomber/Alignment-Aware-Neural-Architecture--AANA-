...
def validate_production_readiness_review(path=DEFAULT_REVIEW):
    ...
    if release_gate.get("script") != "scripts/validate_production_readiness_review.py":
        errors.append("release_gate.script must point to scripts/validate_production_readiness_review.py.")
